      ...
      <section className="relative py-28 bg-[#0B1121] text-white overflow-hidden flex flex-col items-center justify-center border-b border-white/10">
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-slate-700 bg-slate-900/50 backdrop-blur-md mb-8">
            ...
            <span className="text-sm font-medium tracking-wide text-white uppercase">Excellence & Achievements</span>
          </div>
          ...
          {results.map((result) => (
            ...
            >
              <img 
                src={result.src} 
                alt={result.alt}
                className="w-full h-auto max-h-[600px] rounded-2xl object-contain hover:scale-105 transition-transform duration-500"
              />
            </div>
          ))}
        </div>
