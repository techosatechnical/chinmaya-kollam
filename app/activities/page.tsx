              ...
              <Link key={index} href={activity.href} className="group h-full">
                <div className="bg-white rounded-3xl p-8 h-full shadow-lg shadow-slate-200/50 border border-slate-200 hover:border-blue-500/30 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden">
                  ...
                  <div className="relative z-10 flex-1 flex flex-col">
                    <div className={`w-16 h-16 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-sm ${activity.iconColor}`}>
